...
with tab2:
    ...
    try:
        ...
        # Filtramos solo el Top 10 basándonos en Neg Log10 PVal (de mayor a menor)
        df_top10 = df_stats.sort_values(by="Neg Log10 PVal", ascending=False).head(10)
        
        # Resaltamos las columnas más importantes para el médico
        st.dataframe(
            df_top10[["Component", "Significant", "Neg Log10 PVal", "P Value FDR Corrected"]], 
